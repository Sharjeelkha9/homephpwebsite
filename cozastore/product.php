...
if(isset($_GET['cid'])){
	$cid = $_GET['cid'];
	$query = $pdo ->prepare("select * from products where categoryid =:pid");
...
?>
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $proaddress.$proData['image'] ?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?pid=<?php echo $proData['id']?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								<?php echo $proData['name'] ?>
								</a>

								<span class="stext-105 cl3">
								PKR <?php echo $proData['price'] ?>
								</span>
							</div>
